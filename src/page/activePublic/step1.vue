    ...
    data: function () {
      return {
        ...
        rules: {
          ...
          activeStartTimeDate: [{required:false,message:'请选择活动开始日期',trigger:'change'}],
          activeStartTimeTime: [{required:false,message:'请选择活动开始时间',trigger:'change'}],
          activeEndTimeDate:   [{required:false,message:'请选择活动结束日期',trigger:'change'}],
          activeEndTimeTime:   [{required:false,message:'请选择活动结束时间',trigger:'change'}],
          signStartTimeDate:   [{required:false,message:'请选择报名开始日期',trigger:'change'}],
          signStartTimeTime:   [{required:false,message:'请选择报名开始时间',trigger:'change'}],
          signEndTimeDate:     [{required:false,message:'请选择报名截止日期',trigger:'change'}],
          signEndTimeTime:     [{required:false,message:'请选择报名截止时间',trigger:'change'}],
        },
        ruleForm: {
          name: '',
          fenLeis:[
